...
<div className="min-h-screen">
      <div className="min-h-screen bg-gradient-to-br from-white to-yellow-200 h-[610px]">
        <div className="max-w-6xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center">
          {/* Colonne gauche : Image */}

            <img
              src={ananasImg}
              alt="Ananas"
              className=" -mt-10 -ml-10  h-auto object-contain"
            />
          

          {/* Colonne droite : Texte d'accueil */}
          <div className="md:w-1/2 text-center md:text-left -mt-40 md:ml-[-500px]">
            ...
            <p className="text-green-900 md:text-3xl text-lg ">
              Suivez l’origine de votre ananas <br /> en un simple scan.
            </p>
          </div>
        </div>
        </div>
        ...
        {/* Bloc vidéo */}
        <div className="text-center mt-16 pb-50">
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
    ...
    <div>
      ...
      <ul className="text-sm space-y-2">
        ...
        <li> <a href="#" className="hover:underline">Université nationale des sciences, technologies, ingénierie et mathématiques</a></li>
        <li><a href="#" className="hover:underline">Institut National Supérieur De Technologie Industrielle de Lokossa</a></li>
      </ul>
    </div>
